...
const ChatApp = () => {
  ...
  return (
    <div className='h-screen '>
      <div className="flex h-screen border p-2 responsive-width">
        {sidebarOpen && (
          <div className="w-[400px] border-r py-2 px-2  max-xl:w-full max-xl:fixed max-xl:h-full max-xl:bg-white ">
